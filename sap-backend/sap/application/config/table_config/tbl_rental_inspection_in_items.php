...
$config['RENTAL_INSPECTION_IN_ITEMS']['excel_file_name']	= time() . '_rental_inspection_in_items.xlsx';
$config['RENTAL_INSPECTION_IN_ITEMS']['columns_list']		= array(
	array(
		'display_name'		=> 'Id',
		'tbl_field_name' 	=> 'id',
		'field_key' 		=> 'id',
	...
	array(
		'display_name'		=> 'Rental Inspection In Id',
		'tbl_field_name' 	=> 'rental_inspection_in_id',
		'field_key' 		=> 'rentalInspectionInId',
		'field_type' 	 	=> 'number',
		'search_flag'		=> 0,
		'sort_flag'			=> 0,
		'excel_flag'		=> 0,
