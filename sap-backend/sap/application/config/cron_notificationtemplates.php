...
$config['activity_popup_notification']['title'] 	 = 'Activity Notification Mail';
$config['activity_popup_notification']['subject']  = 'Activity Notification Mail';
$config['activity_popup_notification']['body'] 	 = 
'<tr>
